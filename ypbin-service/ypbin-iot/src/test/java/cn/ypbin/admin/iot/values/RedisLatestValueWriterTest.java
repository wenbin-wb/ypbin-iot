...
class RedisLatestValueWriterTest {
    ...
    void mustWritePerDeviceWithExpectedKeyAndTripleArgs() {
        ...
        assertThat(argsOf(argsCaptor, 0)).containsExactly(
    ...
    void mustKeepNewestWithinBatch() {
        ...
        assertThat(argsOf(argsCaptor, 1)).containsExactly(
    ...
    void mustSendOneScriptCallPerDevice() {
        ...
        assertThat(argsCaptor.getAllValues().get(0)).as("同设备 3 个点位共 9 个 ARGV").hasSize(9);
        assertThat(argsCaptor.getAllValues().get(1)).hasSize(3);
